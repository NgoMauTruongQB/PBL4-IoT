...
String serverName = "192.168.0.1";  //--> Change with your server computer's IP address or your Domain name.
// The file path "img" on the server folder.
...
void sendPhotoToServer() {
  ...
  Serial.println("Image Data Length: " + String(imageLen));
...
void loop() {
  int value;
  value = digitalRead(E18);

  // Check if the distance is less than 8 cm
  if ( value == 0) {
    delay(2000);
    sendPhotoToServer();
    delay(8000);
